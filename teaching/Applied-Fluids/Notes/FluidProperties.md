...
Local boiling (transition from a liquid to gas) can also occur when the temperature of the fluid reaches its *boiling point*.  The boiling point of a liquid is the temperature at which its vapor pressure is equal to surround pressure.   For example, vapor lock in a combustion engine occurs when the gasoline vaporizes due to an increase in temperature (either from the engine itself of the surrounding climate) or from a decrease in the atmospheric pressure (at high altitudes).  This is why aviation fuel is manufactured to have a far lower vapor pressure than automotive gasoline.
...
Read more about brake fluid at this <a href="http://www.epicbleedsolutions.com/blog/dot-brake-fluid-vs-mineral-oil/">blog post</a>.
